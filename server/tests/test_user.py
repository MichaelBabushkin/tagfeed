...
@pytest.mark.parametrize(
    ...
    ("username2@ex.ex", "random",                         "r"*(USER_PASSWORD_MIN_LEN - 1),  "random",                          "random",                         422),   # short password
    ("username2@ex.ex", "random",                         "r"*(USER_PASSWORD_MAX_LEN + 1),  "random",                          "random",                         422),   # long password
    ("username2@ex.ex", "random",                         "random",                         None,                              "random",                         422),   # no first_name
    ("username2@ex.ex", "random",                         "random",                         "r"*(USER_FIRST_NAME_MIN_LEN - 1), "random",                         422),   # short first_name
    ("username2@ex.ex", "random",                         "random",                         "r"*(USER_FIRST_NAME_MAX_LEN + 1), "random",                         422),   # long first_name
    ("username2@ex.ex", "random",                         "random",                         "random",                          None,                             422),   # no last_name
    ("username2@ex.ex", "random",                         "random",                         "random",                          "r"*(USER_LAST_NAME_MIN_LEN - 1), 422),   # short last_name
    ("username2@ex.ex", "random",                         "random",                         "random",                          "r"*(USER_LAST_NAME_MAX_LEN + 1), 422),   # long last_name
])
